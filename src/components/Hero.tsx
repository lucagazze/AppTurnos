...
const HeroSection = () => {
    return (
      <div className="flex flex-col lg:flex-row items-center mt-6 0 max-w-7xl mx-auto px-6 h-screen overflow-y-auto">
        ...
        <div className="lg:w-1/2 flex justify-center">
          <img src="/assets/images/Default_haceme_un_buen_logo_que_diga_Algorithmia_que_sea_muy_l_2.png" alt="IMAGEN" />
        </div>
      </div>
    );
  };
